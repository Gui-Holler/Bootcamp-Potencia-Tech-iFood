...
// Saída
// A função deve retornar uma nova string que é a combinação da parte inicial(Préfixo) do nome do Pokémon com o sufixo final do nome, 
// formando um nome de Pokémon completo.
...
// Funções: Aprender como criar e usar funções é um dos conceitos básicos da programação. No código fornecido, 
// a função combinandoNomesPokemons é definida para criar o nome completo de um Pokémon combinando a entrada fornecida com o sufixo "saur".
// Concatenação de Strings: Você usou a operação de concatenação de strings para unir a parte de entrada (prefixo) com o sufixo "saur", 
// criando assim o nome completo do Pokémon.

// Entrada e Saída de Dados: O código utiliza gets() para solicitar ao usuário a entrada da primeira parte do nome do Pokémon. 
// Além de utilizar o print() para imprimir a saída (nome gerado) no console.
...
// Lógica de Programação: Embora seja um desafio relativamente simples, 
// ele requer lógica de programação para compreender como criar um nome de Pokémon completo a partir da entrada fornecida.
...
// Linguagem de Programação JavaScript: O desafio utiliza a linguagem de programação JavaScript, 
// o que proporcionou uma oportunidade para aplicar os conceitos aprendidos em lógica dentro do contexto dessa linguagem.
